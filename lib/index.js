...
var GitHub = /** @class */ (function () {
    ...
    GitHub.prototype.mergeToMainBranch = function (options) {
        return pull_1.mergeToMainBranch.call(this, __assign(__assign({}, options), { github: this.github }));
    };
    GitHub.prototype.mergeBranches = function (options) {
        return pull_1.mergeBranches.call(this, __assign(__assign({}, options), { github: this.github }));
    };
    GitHub.prototype.compareBranches = function (options) {
        return branch_1.compareBranches.call(this, __assign(__assign({}, options), { github: this.github }));
    };
    return GitHub;
}());
