...
exports.compareBranches = exports.checkout = exports.checkBranch = exports.createBranch = exports.getMainBranch = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, utils_node_1.rm(path_1.default.resolve(options.cwd, filename.split(".")[0]))];
            case 3:
                _b.sent();
                return [4 /*yield*/, utils_node_1.rm(path_1.default.resolve(options.cwd, filename))];
            case 4:
                _b.sent();
...
var compareBranches = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var base, mainBranch, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                base = options.base;
                if (!!base) return [3 /*break*/, 2];
                return [4 /*yield*/, exports.getMainBranch({
                        owner: options.owner,
                        repo: options.repo,
            ...
            case 1:
                ...
                _a.label = 2;
            case 2: return [4 /*yield*/, options.github.rest.repos.compareCommitsWithBasehead({
                    owner: options.owner,
                    repo: options.repo,
